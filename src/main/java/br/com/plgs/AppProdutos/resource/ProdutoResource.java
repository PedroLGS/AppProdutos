...
import br.com.plgs.AppProdutos.dto.ProdutoDTO;
import br.com.plgs.AppProdutos.dto.ProdutoSimplesDTO;
import br.com.plgs.AppProdutos.model.Produto;
import br.com.plgs.AppProdutos.service.ProdutoService;
...
public class ProdutoResource {
	...
	/*
	@GetMapping("produto") // http://localhost:8080/api/produtos/produto
	public ResponseEntity<Produto> getProduto() {
		Produto produto = new Produto();
		produto.setId(1L);
		produto.setCodigoBarras("321312312");
		produto.setNome("Produto 1");
		produto.setPreco(55.0);
		return ResponseEntity.ok(produto);
	}

	@GetMapping("salvar") // http://localhost:8080/api/produtos/salvar
	...
	*/
	...
	@GetMapping // http://localhost:8080/api/produtos
	...
	@GetMapping("/{id}") // http://localhost:8080/api/produtos/10
	...
	@PostMapping // http://localhost:8080/api/produtos
	...
	@PutMapping // http://localhost:8080/api/produtos
	...
	@DeleteMapping("/{id}") // http://localhost:8080/api/produtos/2
	...
	@GetMapping("/produtoAndQte") // http://localhost:8080/api/produtos/produtoAndQte
	...
	@GetMapping("/produtoAndQte/{qte}") // http://localhost:8080/api/produtos/produtoAndQte/20
